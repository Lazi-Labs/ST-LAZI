/**
 * Sync worker for Campaign categories
...
export class CampaignCategoriesSyncWorker extends BaseSyncWorker {
  readonly endpointName = 'campaign_categories';
  readonly stEndpointPath = 'https://api.servicetitan.io/marketing/v2/tenant/3222348440/categories';
  readonly rawTable = 'raw.st_campaign_categories';
  readonly masterTable = 'master.campaign_categories';
