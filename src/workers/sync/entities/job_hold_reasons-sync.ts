/**
 * Sync worker for Job hold reasons
...
export class JobHoldReasonsSyncWorker extends BaseSyncWorker {
  readonly endpointName = 'job_hold_reasons';
  readonly stEndpointPath = 'https://api.servicetitan.io/jpm/v2/tenant/3222348440/job-hold-reasons';
  readonly rawTable = 'raw.st_job_hold_reasons';
  readonly masterTable = 'master.job_hold_reasons';
